...
if(isset($_POST['buscar'])){
        ...
        $sql="SELECT *  FROM llamadas2023 WHERE id = '$nombre' ";
...
Verificentro: <?php echo $row['centro']; ?><br>

Atendio: <?php echo $row['atendio']; ?><br>

Tema: <?php echo $row['tema']; ?><br>

Descripcion: <?php echo $row['motivo']; ?><br>

Fecha: <?php echo $row['fecha']; ?><br>

Desde: <?php echo $row['desde']; ?><br>

Motivo: <?php echo $row['motivo']; ?><br>

Seguimiento: <?php echo $row['termino']; ?><br>
...
<button type="button" class="btn btn-warning"  data-bs-toggle="modal" data-bs-target="#editChildresn<?php echo $row['id']; ?>">
                                  ...
                                  Termino
                                                ...
                                                <?php  include('llamadas_modal_editar.php'); ?>
